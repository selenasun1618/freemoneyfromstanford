      ...
      <main className="mb-auto flex flex-row justify-center text-white">
          <div className="bg-digital-red w-full pt-10">
              <div className="container mx-auto md:p-4 md:pb-10">
                  ...
                  <form className={"flex flex-col grow sm:rounded-2xl bg-digital-red px-5 pb-5"}>
                      {/*<h5 className={"text-center text-lg font-medium my-4"}>*/}
                      {/*    Search your topic, and we'll suggest some grants that might cover it!*/}
                      ...
                      <div className={"my-2 mx-3 flex flex-row grow"}>
                          ...
                          <input type="submit" formAction="/search" value="Search"
                                 className={"rounded-r-3xl py-3 px-4 bg-digital-red-light cursor-pointer"}
